...
## Zusaetzliche technische Follow-ups
1. **MEDIUM** - Timer-Genauigkeit bei laengeren Sessions validieren  
   - Datei: `app/src/main/java/com/example/myapplication/TimerViewModel.kt` (`startTimer()`)  
   - Testfaelle: 25 / 60 / 120 Minuten, inkl. Vordergrund/Hintergrund.

2. **MEDIUM** - Notification-Verhalten fuer Android 12+ absichern  
   - Datei: `app/src/main/java/com/example/myapplication/utils/NotificationHelper.kt`  
   - Fokus: PendingIntent-/OEM-Randfaelle auf realen Geraeten.
